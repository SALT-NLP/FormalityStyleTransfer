...
def add_optimization_args(parser):
    ...
    # fmt: off
    group.add_argument('--disc-epochs', default=0, type=int,
                            help='disc epochs')
    group.add_argument('--label-smoothing', default=0., type=float, metavar='D',
                            help='epsilon for label smoothing, 0 means no label smoothing')
    group.add_argument('--disc-weight', default=1., type=float,
                            help='weight for classification loss')
    group.add_argument('--recon-weight', default=1., type=float,
                            help='weight for self-reconstruction loss')
    group.add_argument('--cycle-weight', default=1., type=float,
                       help='weight for cycled reconstruction loss')
    group.add_argument('--weight-forward', default=0.5, type=float,
                            help='weight for forward pass')
    group.add_argument('--trans-only-epoch', default=2, type=int, metavar='N',
                       help='epochs for which cyclic and reconstruction losses will be ignored')
    group.add_argument('--max-epoch', default=10, type=int, metavar='N',
