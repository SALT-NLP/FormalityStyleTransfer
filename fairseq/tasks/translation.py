...
class TranslationTask(FairseqTask):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        print("Loading " + split + " dataset for epoch "+str(epoch))
        print(data_path)
    ...
    def build_model(self, args):
        ...
        #model.register_classification_head('formal',num_classes =2, inner_dim=1024)
        return model

    def valid_step(self, sample, model, criterion, update_num):
        loss, sample_size, logging_output = super().valid_step(sample, model, criterion, update_num)
